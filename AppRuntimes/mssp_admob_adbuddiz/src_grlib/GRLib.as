...
package
{
	...
	public class GRLib extends Sprite
	{
		...
		public function bindRoot( r:IEventDispatcher )
		{
			...
			// ad
			CONFIG::ANDROID{
				JuHeGg.instance.init( grConf.aoaoAppID, grConf.baiduAndroidAppID,grConf.baiduAndroidBanner,grConf.baiduAndroidInterstitial, grConf.admobAndroidBanner, grConf.admobAndroidInterstitial ,grConf.androidAdbuddizInterstitial);
			}
			CONFIG::IOS{
				JuHeGg.instance.init( grConf.aoaoAppID, grConf.baiduIOSAppID,grConf.baiduIOSBanner,grConf.baiduIOSInterstitial, grConf.admobIOSBanner, grConf.admobIOSInterstitial, grConf.iosAdbuddizInterstitial );
			}
