package pintie
{
	...
	public class LevelModel extends Object
	{
		...
		{
			var file:File = File.applicationDirectory.resolvePath( GameConf.PICSFOLDER + level_ + ".png" );
			if( !file.exists )
			{
				file = File.applicationDirectory.resolvePath( GameConf.PICSFOLDER + level_ + ".jpg" );
			}
			return file;
		}
		/**
