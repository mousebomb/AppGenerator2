package org.mousebomb.tianse
{
	 ...
	 * @author Mousebomb
	 */
	public class TSPaintedModel
	{
		private static var _instance : TSPaintedModel;

		public static function getInstance() : TSPaintedModel
		{
			if (_instance == null)
			{
				_instance = new TSPaintedModel(new SingletonEnforcer());
			}
			return _instance;
		}

		public function TSPaintedModel(s : SingletonEnforcer)
		{
		}
 ...
 */
		...
		{
			so = SharedObject.getLocal(GameConf.LOCAL_SO_NAME);
			for each(var picId :int in GameConf.TS_LIST_IDS)
			{var savKey : String = "pic" + picId;
				so.data[savKey]=null;
