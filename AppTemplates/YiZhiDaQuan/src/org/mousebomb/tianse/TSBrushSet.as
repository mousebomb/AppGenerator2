package org.mousebomb.tianse
{
	 ...
	 * @author Mousebomb
	 */
	public class TSBrushSet extends Sprite
	{
...
//			graphics.endFill();
			...
			//
			this.x = (GameConf.DESIGN_SIZE_W - cols * colorBtnSize) /2 ;
			this.y = GameConf.VISIBLE_SIZE_H_MINUS_AD - rows* _shelf.marginY;//GameConf.VISIBLE_SIZE_H
		}
