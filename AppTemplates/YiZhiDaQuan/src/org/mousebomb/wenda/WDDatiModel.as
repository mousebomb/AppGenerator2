...
package org.mousebomb.wenda
{
	...
	public class WDDatiModel
	{
		public function WDDatiModel()
		{
		}
		...
		public function drive() : void
		{
			...
			GlobalFacade.sendNotify( NotifyConst.BIRDS_MOVE, this );
			if (isFinished)
			{
				// 计算时间和名次 （飞行速度换算成秒）
				...
				//
				GlobalFacade.sendNotify( NotifyConst.PLAYER_FINISH, this );
			}
		}
		...
		private function slowDown(delta : int) : void
		{
			...
			if (playerBird.speed < playerMinSpeed)
			{
				playerBird.speed = playerMinSpeed;
			}
			playerSpeedForShow = playerBird.speed / playerMaxSpeed * 100;
			GlobalFacade.sendNotify( NotifyConst.PLAYER_SPEED_CHANGE, this );
		}
