package org.mousebomb.pin9gong {
	 ...
	 * @author rhett
	 */
	public class P9HoleLi extends Sprite {
		private var child : P9PartShape;
		...
		public function setContent(_curLevelBitmap : Bitmap, rect : Rectangle,shapeId:uint, type : String) : void {
			...
			child = new P9PartShape(_curLevelBitmap, _rect, shapeId);
			var holeW : Number = _rect.width;
			var holeH : Number = _rect.height;
			if (type == P9HoleLi.DRAG_SOURCE)
			{
				holeW = P9HoleLi.HOLE_W_SMALL;
				holeH = P9HoleLi.HOLE_H_SMALL;
			}
...
//			addChild(new TestFlag());
		...
		public function playCorrect() : void {
			...
			} else if (type == P9HoleLi.DRAG_TARGET) {
				child.show();
				scaleX = suitW * 1.3;
				scaleY = suitH * 1.3;
