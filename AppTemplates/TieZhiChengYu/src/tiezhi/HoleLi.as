...
import flash.geom.Point;
	...
	public class HoleLi extends Sprite
	{
		...
		public static const HOLE_W : Number = 140;
		public static const HOLE_H : Number = 140;
		public static const HOLE_W_SMALL : Number = 120;
		public static const HOLE_H_SMALL : Number = 120;
...
//				this.graphics.lineStyle(2,0xff0000);
			...
			else
			{
				...
				roundPic.width = 2.3*HOLE_W;
				roundPic.height =2.3* HOLE_H;
				roundPic.x = HOLE_W /2;
				roundPic.y = HOLE_H /2;
				addChild(roundPic);
			}
